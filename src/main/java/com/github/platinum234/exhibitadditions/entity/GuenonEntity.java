...
public class GuenonEntity extends ZawaLandEntity implements SpeciesVariantsEntity, ClimbingEntity {
    public static final EntityDataAccessor<Boolean> CLIMBING = SynchedEntityData.defineId(GuenonEntity.class, EntityDataSerializers.BOOLEAN);

    public GuenonEntity(EntityType<? extends ZawaLandEntity> type, Level world) {
        super(type, world);
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel world, AgeableMob entity) {
        return ExhibitAdditionsEntities.GUENON.get().create(world);
    }
