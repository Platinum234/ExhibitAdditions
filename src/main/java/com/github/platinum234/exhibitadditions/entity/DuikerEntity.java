...
public class DuikerEntity extends ZawaLandEntity implements SpeciesVariantsEntity {
    public DuikerEntity(EntityType<? extends ZawaLandEntity> type, World world) {
        super(type, world);
    }
    ...
    public AgeableEntity getBreedOffspring(ServerWorld world, AgeableEntity entity) {
        return ExhibitAdditionsEntities.DUIKER.get().create(world);
    }
