...
public class GerenukEntity extends ZawaLandEntity {
    public GerenukEntity(EntityType<? extends ZawaLandEntity> type, World world) {
        super(type, world);
    }
    ...
    public AgeableEntity getBreedOffspring(ServerWorld world, AgeableEntity entity) {
        return ExhibitAdditionsEntities.GERENUK.get().create(world);
    }
