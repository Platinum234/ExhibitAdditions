...
public class PottoEntity extends ZawaLandEntity implements ClimbingEntity {
    public static final EntityDataAccessor<Boolean> CLIMBING = SynchedEntityData.defineId(PottoEntity.class, EntityDataSerializers.BOOLEAN);

    public PottoEntity(EntityType<? extends ZawaLandEntity> type, Level world) {
        super(type, world);
    }
