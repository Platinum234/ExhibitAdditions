...
public abstract class PronghornModel extends ZawaBaseModel<PronghornEntity> {
    ...
    public static class Adult extends PronghornModel {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            PartDefinition Chest = partDefinition.addOrReplaceChild("Chest", CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, -4.0F, -3.0F, 5.0F, 8.0F, 6.0F), PartPose.offsetAndRotation(0.0F, 11.0F, -6.1F, -0.13962634015954636F, 0.0F, 0.0F));
            PartDefinition ArmBaseRight = Chest.addOrReplaceChild("ArmBaseRight", CubeListBuilder.create().texOffs(22, 34).mirror(true).addBox(-1.5F, 0.0F, -2.0F, 3.0F, 6.0F, 4.0F), PartPose.offsetAndRotation(-2.0F, -1.3F, -0.7F, 0.2275909337942703F, 0.0F, 0.0F));
            PartDefinition UpperArmRight = ArmBaseRight.addOrReplaceChild("UpperArmRight", CubeListBuilder.create().texOffs(37, 35).mirror(true).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 4.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 5.8F, 1.0F, -0.08726646259971647F, 0.0F, 0.0F));
            PartDefinition ArmRight = UpperArmRight.addOrReplaceChild("ArmRight", CubeListBuilder.create().texOffs(46, 35).mirror(true).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 4.0F, 2.0F), PartPose.offset(0.01F, 3.8F, -2.0F));
            PartDefinition HandRight = ArmRight.addOrReplaceChild("HandRight", CubeListBuilder.create().texOffs(55, 37).mirror(true).addBox(-1.0F, -0.0F, -1.5F, 2.0F, 2.0F, 2.0F), PartPose.offset(0.1F, 2.9F, 0.8F));

            PartDefinition ArmBaseLeft = Chest.addOrReplaceChild("ArmBaseLeft", CubeListBuilder.create().texOffs(22, 34).addBox(-1.5F, 0.0F, -2.0F, 3.0F, 6.0F, 4.0F), PartPose.offsetAndRotation(2.0F, -1.3F, -0.7F, 0.2275909337942703F, 0.0F, 0.0F));
            PartDefinition UpperArmLeft = ArmBaseLeft.addOrReplaceChild("UpperArmLeft", CubeListBuilder.create().texOffs(37, 35).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 4.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 5.8F, 1.0F, -0.08726646259971647F, 0.0F, 0.0F));
            PartDefinition ArmLeft = UpperArmLeft.addOrReplaceChild("ArmLeft", CubeListBuilder.create().texOffs(46, 35).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 4.0F, 2.0F), PartPose.offset(-0.01F, 3.8F, -2.0F));
            PartDefinition HandLeft = ArmLeft.addOrReplaceChild("HandLeft", CubeListBuilder.create().texOffs(55, 37).addBox(-1.0F, -0.0F, -1.5F, 2.0F, 2.0F, 2.0F), PartPose.offset(-0.1F, 2.9F, 0.8F));

            PartDefinition Body = Chest.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(27, 1).addBox(-3.0F, -0.5F, -1.0F, 6.0F, 8.0F, 7.0F), PartPose.offsetAndRotation(0.0F, -3.5F, 2.5F, 0.18203784630933073F, 0.0F, 0.0F));
            PartDefinition Hips = Body.addOrReplaceChild("Hips", CubeListBuilder.create().texOffs(0, 16).addBox(-2.5F, -0.5F, 0.0F, 5.0F, 8.0F, 5.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 5.5F, -0.0911061832922575F, 0.0F, 0.0F));
            PartDefinition Tail = Hips.addOrReplaceChild("Tail", CubeListBuilder.create().texOffs(50, 52).addBox(-1.0F, -0.6F, 0.0F, 2.0F, 2.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 4.5F, -0.8651597048872669F, 0.0F, 0.0F));

            PartDefinition ThighRight = Hips.addOrReplaceChild("ThighRight", CubeListBuilder.create().texOffs(0, 49).mirror(true).addBox(-1.5F, -1.5F, -2.0F, 3.0F, 8.0F, 5.0F), PartPose.offset(-2.1F, 1.5F, 2.3F));
            PartDefinition UpperLegRight = ThighRight.addOrReplaceChild("UpperLegRight", CubeListBuilder.create().texOffs(19, 54).mirror(true).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 4.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 5.9F, -0.5F, 0.8196066007575706F, 0.0F, 0.0F));
            PartDefinition LowerLegRight = UpperLegRight.addOrReplaceChild("LowerLegRight", CubeListBuilder.create().texOffs(32, 53).mirror(true).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 7.0F, 2.0F), PartPose.offsetAndRotation(0.05F, 3.5F, 1.5F, -0.956091342937205F, 0.0F, 0.0F));
            PartDefinition FootRight = LowerLegRight.addOrReplaceChild("FootRight", CubeListBuilder.create().texOffs(55, 37).mirror(true).addBox(-1.0F, 0.0F, -1.5F, 2.0F, 2.0F, 2.0F), PartPose.offsetAndRotation(0.1F, 6.0F, -1.4F, 0.18203784630933073F, 0.0F, 0.0F));

            PartDefinition ThighLeft = Hips.addOrReplaceChild("ThighLeft", CubeListBuilder.create().texOffs(0, 49).addBox(-1.5F, -1.5F, -2.0F, 3.0F, 8.0F, 5.0F), PartPose.offset(2.0F, 1.5F, 2.3F));
            PartDefinition UpperLegLeft = ThighLeft.addOrReplaceChild("UpperLegLeft", CubeListBuilder.create().texOffs(19, 54).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 4.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 6.0F, -0.5F, 0.8196066007575706F, 0.0F, 0.0F));
            PartDefinition LowerLegLeft = UpperLegLeft.addOrReplaceChild("LowerLegLeft", CubeListBuilder.create().texOffs(32, 53).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 7.0F, 2.0F), PartPose.offsetAndRotation(-0.05F, 3.5F, 1.5F, -0.956091342937205F, 0.0F, 0.0F));
            PartDefinition FootLeft = LowerLegLeft.addOrReplaceChild("FootLeft", CubeListBuilder.create().texOffs(55, 37).addBox(-1.0F, 0.0F, -1.5F, 2.0F, 2.0F, 2.0F), PartPose.offsetAndRotation(-0.1F, 6.0F, -1.4F, 0.18203784630933073F, 0.0F, 0.0F));

            PartDefinition Neck = Chest.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(31, 17).addBox(-1.5F, -1.0F, -4.4F, 3.0F, 4.0F, 8.0F), PartPose.offsetAndRotation(0.0F, -3.5F, -2.5F, -0.8196066007575706F, 0.0F, 0.0F));
            PartDefinition Head = Neck.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 34).addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F), PartPose.offsetAndRotation(0.0F, 2.0F, -3.5F, 1.0016444470669013F, 0.0F, 0.0F));
            PartDefinition Horn1Right = Head.addOrReplaceChild("Horn1Right", CubeListBuilder.create().texOffs(8, 29).addBox(-0.5F, -3.0F, -1.0F, 1.0F, 3.0F, 2.0F), PartPose.offsetAndRotation(-1.5F, -2.0F, -0.8F, 0.4098033003787853F, 0.0F, -0.500909508638178F));
            PartDefinition Horn2Right = Horn1Right.addOrReplaceChild("Horn2Right", CubeListBuilder.create().texOffs(16, 39).addBox(-0.5F, -1.0F, -1.0F, 1.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(-0.1F, -2.8F, 0.01F, 0.0F, 0.0F, 0.3642502295386026F));
            PartDefinition Horn3Right = Horn2Right.addOrReplaceChild("Horn3Right", CubeListBuilder.create().texOffs(16, 36).addBox(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(-0.01F, -0.5F, -0.5F, 0.591841146688116F, 0.0F, 0.0F));
            PartDefinition Horn4Right = Horn3Right.addOrReplaceChild("Horn4Right", CubeListBuilder.create().texOffs(15, 32).addBox(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 1.6F, -0.45535640450848164F, 0.45535640450848164F, 0.0F));

            PartDefinition Horn5Right = Horn2Right.addOrReplaceChild("Horn5Right", CubeListBuilder.create().texOffs(16, 36).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(0.01F, -0.5F, -0.5F, -0.591841146688116F, -0.45535640450848164F, 0.0F));
            PartDefinition Horn6Right = Horn5Right.addOrReplaceChild("Horn6Right", CubeListBuilder.create().texOffs(22, 35).addBox(-0.5F, -0.5F, -1.0F, 1.0F, 1.0F, 1.0F), PartPose.offsetAndRotation(0.0F, 0.01F, -1.5F, 0.0F, -0.45535640450848164F, 0.0F));

            PartDefinition EarRight = Head.addOrReplaceChild("EarRight", CubeListBuilder.create().texOffs(0, 29).mirror(true).addBox(-1.0F, -4.0F, 0.0F, 2.0F, 4.0F, 1.0F), PartPose.offsetAndRotation(-1.5F, 0.0F, 1.0F, 0.13665927909957545F, 0.6373942508178124F, -0.6373942508178124F));

            PartDefinition Horn1Left = Head.addOrReplaceChild("Horn1Left", CubeListBuilder.create().texOffs(8, 29).mirror(true).addBox(-0.5F, -3.0F, -1.0F, 1.0F, 3.0F, 2.0F), PartPose.offsetAndRotation(1.5F, -2.0F, -0.8F, 0.4098033003787853F, 0.0F, 0.500909508638178F));
            PartDefinition Horn2Left = Horn1Left.addOrReplaceChild("Horn2Left", CubeListBuilder.create().texOffs(16, 39).mirror(true).addBox(-0.5F, -1.0F, -1.0F, 1.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(0.1F, -2.8F, 0.01F, 0.0F, 0.0F, -0.3642502295386026F));
            PartDefinition Horn5Left = Horn2Left.addOrReplaceChild("Horn5Left", CubeListBuilder.create().texOffs(16, 36).mirror(true).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(0.01F, -0.5F, -0.5F, -0.591841146688116F, 0.45535640450848164F, 0.0F));
            PartDefinition Horn6Left = Horn5Left.addOrReplaceChild("Horn6Left", CubeListBuilder.create().texOffs(22, 35).mirror(true).addBox(-0.5F, -0.5F, -1.0F, 1.0F, 1.0F, 1.0F), PartPose.offsetAndRotation(0.0F, 0.01F, -1.5F, 0.0F, 0.45535640450848164F, 0.0F));

            PartDefinition Horn3Left = Horn2Left.addOrReplaceChild("Horn3Left", CubeListBuilder.create().texOffs(16, 36).mirror(true).addBox(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(0.01F, -0.5F, -0.5F, 0.591841146688116F, 0.0F, 0.0F));
            PartDefinition Horn4Left = Horn3Left.addOrReplaceChild("Horn4Left", CubeListBuilder.create().texOffs(15, 32).mirror(true).addBox(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 1.6F, -0.45535640450848164F, -0.45535640450848164F, 0.0F));

            PartDefinition EarLeft = Head.addOrReplaceChild("EarLeft", CubeListBuilder.create().texOffs(0, 29).addBox(-1.0F, -4.0F, 0.0F, 2.0F, 4.0F, 1.0F), PartPose.offsetAndRotation(1.5F, 0.0F, 1.0F, 0.13665927909957545F, -0.6373942508178124F, 0.6373942508178124F));

            PartDefinition Mouth = Head.addOrReplaceChild("Mouth", CubeListBuilder.create().texOffs(15, 45).addBox(-1.0F, -0.5F, -3.3F, 2.0F, 1.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 2.0F, -1.5F, 0.04555309164612875F, 0.0F, 0.0F));

            PartDefinition Snout = Head.addOrReplaceChild("Snout", CubeListBuilder.create().texOffs(0, 43).addBox(-1.5F, -1.0F, -3.5F, 3.0F, 2.0F, 4.0F), PartPose.offsetAndRotation(0.0F, 0.5F, -1.8F, 0.27314402127920984F, 0.0F, 0.0F));
            PartDefinition Nose = Snout.addOrReplaceChild("Nose", CubeListBuilder.create().texOffs(26, 44).addBox(-1.0F, -1.0F, -3.0F, 2.0F, 1.0F, 4.0F), PartPose.offsetAndRotation(0.0F, -0.8F, 0.0F, 0.27314402127920984F, 0.0F, 0.0F));

            PartDefinition LowerNeck = Neck.addOrReplaceChild("LowerNeck", CubeListBuilder.create().texOffs(17, 22).addBox(-1.0F, -1.0F, -2.5F, 2.0F, 2.0F, 8.0F), PartPose.offsetAndRotation(0.0F, 2.9F, 0.0F, -0.0911061832922575F, 0.0F, 0.0F));
