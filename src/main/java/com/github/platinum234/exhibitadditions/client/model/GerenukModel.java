...
public abstract class GerenukModel extends ZawaBaseModel<GerenukEntity> {
    ...
    public static class Child extends GerenukModel {
        ...
        public Child() {
            this.texWidth = 48;
            this.texHeight = 32;
            this.ArmBaseRight = new ModelRenderer(this, 30, 6);
            ...
            this.UpperLegRight = new ModelRenderer(this, 40, 7);
            this.UpperLegRight.mirror = true;
            this.UpperLegRight.setPos(0.0F, 3.9F, -0.8F);
            ...
            this.ArmRight = new ModelRenderer(this, 31, 12);
            this.ArmRight.mirror = true;
            this.ArmRight.setPos(0.0F, 2.8F, 0.9F);
            ...
            this.Nose = new ModelRenderer(this, 6, 29);
            ...
            this.ArmBaseLeft = new ModelRenderer(this, 30, 6);
            ...
            this.Tail1 = new ModelRenderer(this, 14, 11);
            ...
            this.setRotateAngle(Head, -0.1265363707695889F, 0.0F, 0.0F);
            this.HandRight = new ModelRenderer(this, 35, 18);
            this.HandRight.mirror = true;
            this.HandRight.setPos(0.01F, 3.7F, 0.3F);
            this.HandRight.addBox(-0.5F, 0.0F, -0.5F, 1.0F, 1.0F, 1.0F, 0.0F, 0.0F, 0.0F);
            this.EarLeft = new ModelRenderer(this, 28, 27);
            this.EarLeft.setPos(1.8F, -1.2F, 1.1F);
            this.EarLeft.addBox(-1.0F, -2.0F, -1.0F, 1.0F, 3.0F, 2.0F, 0.0F, 0.0F, 0.0F);
            this.setRotateAngle(EarLeft, -0.8782496742772243F, 0.7009242249377616F, 0.10471975511965977F);
            this.ThighLeft = new ModelRenderer(this, 37, 0);
            ...
            this.Neck2 = new ModelRenderer(this, 22, 6);
            this.Neck2.setPos(0.0F, 0.0F, -0.45F);
            this.Neck2.addBox(-1.0F, -5.0F, -1.0F, 2.0F, 5.0F, 2.0F, 0.0F, 0.0F, 0.0F);
            this.setRotateAngle(Neck2, -0.2841396142089017F, 0.0F, 0.0F);
            this.LegLeft = new ModelRenderer(this, 37, 12);
            ...
            this.FootLeft = new ModelRenderer(this, 35, 18);
            this.FootLeft.setPos(-0.01F, 4.2F, -0.8F);
            this.FootLeft.addBox(-0.5F, 0.0F, -0.5F, 1.0F, 1.0F, 1.0F, 0.0F, 0.0F, 0.0F);
            this.ArmLeft = new ModelRenderer(this, 31, 12);
            this.ArmLeft.setPos(0.0F, 2.8F, 0.9F);
            ...
            this.EarRight = new ModelRenderer(this, 28, 27);
            this.EarRight.mirror = true;
            this.EarRight.setPos(-1.8F, -1.2F, 1.1F);
            this.EarRight.addBox(0.0F, -2.0F, -1.0F, 1.0F, 3.0F, 2.0F, 0.0F, 0.0F, 0.0F);
            this.setRotateAngle(EarRight, -0.8782496742772243F, -0.7009242249377616F, -0.10471975511965977F);
            this.UpperLegLeft = new ModelRenderer(this, 40, 7);
            this.UpperLegLeft.setPos(0.0F, 3.9F, -0.8F);
            ...
            this.Hips.addBox(-2.0F, 0.0F, 0.0F, 4.0F, 5.0F, 3.0F, -0.1F, 0.0F, 0.0F);
        ...
        public void playIdleAnimation(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
            float speed = 1.0f;
            float degree = 1.0f;
            this.Neck1.xRot = MathHelper.cos(2.0F + limbSwing * speed * 0.07F) * limbSwingAmount * (degree * 0.2F) * 0.5F + 0.657F;
            this.Head.xRot = MathHelper.cos(4.0F + limbSwing * speed * 0.07F) * limbSwingAmount * (degree * -0.15F) * 0.5F - 0.126F;

            this.Tail1.xRot = MathHelper.cos(3.0F + limbSwing * speed * 0.07F) * limbSwingAmount * (degree * -0.2F) * 0.5F - 1.239F;
            this.Tail1.zRot = MathHelper.cos(1.0F + limbSwing * speed * 0.07F) * limbSwingAmount * (degree * 0.3F) * 0.5F;
        }
        ...
        public void playMovementAnimation(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
            float speed = 1.2f;
            float degree = 0.8f;
            this.Neck1.xRot = MathHelper.cos(1.0F + limbSwing * speed * 0.4F) * limbSwingAmount * (degree * 0.15F) * 0.5F + 0.657F;
            this.Head.xRot = MathHelper.cos(3.0F + limbSwing * speed * 0.4F) * limbSwingAmount * (degree * -0.1F) * 0.5F - 0.126F;
            this.Chest.y = MathHelper.cos(2.0F + limbSwing * speed * 0.4F) * limbSwingAmount * (degree * -0.7F) * 0.5F + 13.9F;
            this.Chest.xRot = MathHelper.cos(3.0F + limbSwing * speed * 0.4F) * limbSwingAmount * (degree * 0.02F) * 0.5F - 0.174F;
            this.Body.xRot = MathHelper.cos(2.0F + limbSwing * speed * 0.4F) * limbSwingAmount * (degree * -0.1F) * 0.5F + 0.226F;
            this.ArmBaseLeft.xRot = MathHelper.cos(4.0F + limbSwing * speed * 0.2F) * limbSwingAmount * (degree * -0.9F) * 0.5F + 0.234F;
            this.ArmLeft.xRot = MathHelper.cos(1.0F + limbSwing * speed * 0.2F) * limbSwingAmount * (degree * 1.3F) * 0.5F - 0.052F;
            this.ForearmLeft.xRot = MathHelper.cos(5.0F + limbSwing * speed * 0.2F) * limbSwingAmount * (degree * 1.3F) * 0.5F;
            this.HandLeft.xRot = MathHelper.cos(4.0F + limbSwing * speed * 0.2F) * limbSwingAmount * (degree * -1.8F) * 0.5F;
            this.ArmBaseRight.xRot = MathHelper.cos(4.0F + limbSwing * speed * 0.2F) * limbSwingAmount * (degree * 0.9F) * 0.5F + 0.234F;
            this.ArmRight.xRot = MathHelper.cos(1.0F + limbSwing * speed * 0.2F) * limbSwingAmount * (degree * -1.3F) * 0.5F  -0.052F;
            this.ForearmRight.xRot = MathHelper.cos(5.0F + limbSwing * speed * 0.2F) * limbSwingAmount * (degree * -1.3F) * 0.5F;
            this.HandRight.xRot = MathHelper.cos(4.0F + limbSwing * speed * 0.2F) * limbSwingAmount * (degree * 1.8F) * 0.5F;
            this.ThighLeft.xRot = MathHelper.cos(3.0F + limbSwing * speed * 0.2F) * limbSwingAmount * (degree * 2.3F) * 0.5F + 0.218F;
            this.UpperLegLeft.xRot = MathHelper.cos(1.0F + limbSwing * speed * 0.2F) * limbSwingAmount * (degree * 1.5F) * 0.5F + 0.471F;
            this.LegLeft.xRot = MathHelper.cos(1.0F + limbSwing * speed * 0.2F) * limbSwingAmount * (degree * -1.5F) * 0.5F - 0.453F;
            this.FootLeft.xRot = MathHelper.cos(1.0F + limbSwing * speed * 0.2F) * limbSwingAmount * (degree * -1.5F) * 0.5F;
            this.ThighRight.xRot = MathHelper.cos(3.0F + limbSwing * speed * 0.2F) * limbSwingAmount * (degree * -2.3F) * 0.5F + 0.218F;
            this.UpperLegRight.xRot = MathHelper.cos(1.0F + limbSwing * speed * 0.2F) * limbSwingAmount * (degree * -1.5F) * 0.5F + 0.471F;
            this.LegRight.xRot = MathHelper.cos(1.0F + limbSwing * speed * 0.2F) * limbSwingAmount * (degree * 1.5F) * 0.5F - 0.453F;
