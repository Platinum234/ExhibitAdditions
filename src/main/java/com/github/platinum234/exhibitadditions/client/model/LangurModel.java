...
public abstract class LangurModel extends ZawaBaseModel<LangurEntity> {
    ...
    public static class Adult extends LangurModel {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            partDefinition.addOrReplaceChild("CheekRight1", CubeListBuilder.create().texOffs(0, 15).mirror(true).addBox(0.1F, -1.0F, -1.5F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.2F, 0.0F, 0.0F)), PartPose.offsetAndRotation(-2.3F, 0.6F, -0.5F, -0.23457224414434488F, 0.03909537541112055F, 0.11746065899211351F));
            partDefinition.addOrReplaceChild("ThighLeft", CubeListBuilder.create().texOffs(18, 27).addBox(-1.5F, -0.5F, -2.5F, 3.0F, 7.0F, 4.0F), PartPose.offsetAndRotation(2.2F, 1.3F, 6.4F, -0.1563815016444822F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ArmLeft", CubeListBuilder.create().texOffs(24, 55).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 5.0F, 2.0F), PartPose.offsetAndRotation(-0.1F, 4.5F, 1.0F, -0.27314402127920984F, 0.0F, 0.13665927909957545F));
            partDefinition.addOrReplaceChild("ThumbLeft", CubeListBuilder.create().texOffs(16, 39).addBox(-1.0F, -0.5F, -2.0F, 1.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(-0.1F, -0.5F, 0.0F, 0.08726646259971647F, 0.13665927909957545F, 0.0F));
            partDefinition.addOrReplaceChild("CheekLeft3", CubeListBuilder.create().texOffs(8, 43).addBox(0.0F, 0.0F, -0.5F, 3.0F, 4.0F, 1.0F, new CubeDeformation(0.2F, 0.0F, 0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("HandRight", CubeListBuilder.create().texOffs(15, 46).mirror(true).addBox(-1.0F, -1.0F, -2.5F, 2.0F, 1.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 5.8F, -0.5F, 0.0781907508222411F, 0.0F, 0.11728612207217244F));
            partDefinition.addOrReplaceChild("Tail8", CubeListBuilder.create().texOffs(16, 58).addBox(-1.0F, -4.0F, -2.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.06F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, 0.0F, 0.5235987755982988F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("TopSnout", CubeListBuilder.create().texOffs(0, 36).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 0.0F, -1.9F, 0.6576400674777856F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ThumbRight", CubeListBuilder.create().texOffs(16, 39).mirror(true).addBox(0.0F, -0.5F, -2.0F, 1.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(0.1F, -0.5F, 0.0F, 0.08726646259971647F, -0.13665927909957545F, 0.0F));
            partDefinition.addOrReplaceChild("CheekLeft1", CubeListBuilder.create().texOffs(0, 15).addBox(-2.1F, -1.0F, -1.5F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.2F, 0.0F, 0.0F)), PartPose.offsetAndRotation(2.3F, 0.6F, -0.5F, -0.23457224414434488F, -0.03909537541112055F, -0.11746065899211351F));
            partDefinition.addOrReplaceChild("ArmRight", CubeListBuilder.create().texOffs(24, 55).mirror(true).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 5.0F, 2.0F), PartPose.offsetAndRotation(0.1F, 4.5F, 1.0F, -0.27314402127920984F, 0.0F, -0.13665927909957545F));
            partDefinition.addOrReplaceChild("NeckLower", CubeListBuilder.create().texOffs(1, 27).addBox(-1.5F, 0.0F, 0.0F, 3.0F, 2.0F, 5.0F, new CubeDeformation(-0.5F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 1.8F, -2.8F, 1.4505431519851317F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Cheeks", CubeListBuilder.create().texOffs(0, 56).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.3F, 0.3F, 0.0F)), PartPose.offset(0.0F, 0.0F, 0.2F));
            partDefinition.addOrReplaceChild("LegLeft", CubeListBuilder.create().texOffs(22, 38).addBox(0.0F, 0.0F, 0.0F, 2.0F, 7.0F, 3.0F), PartPose.offsetAndRotation(-1.0F, 6.5F, -2.0F, 0.4557054783483638F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Tail4", CubeListBuilder.create().texOffs(16, 58).addBox(-1.0F, -4.0F, -2.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.13999999F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, 0.0F, 0.5235987755982988F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Mouth", CubeListBuilder.create().texOffs(0, 40).addBox(-1.0F, 0.0F, -1.75F, 2.0F, 1.0F, 2.0F, new CubeDeformation(-0.1F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 1.6F, -0.1F, -0.19495327877934715F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Hips", CubeListBuilder.create().texOffs(3, 14).addBox(-3.5F, -0.5F, 0.0F, 7.0F, 6.0F, 7.0F), PartPose.offsetAndRotation(0.0F, -2.5F, 4.3F, -0.14032447119455382F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("EarRight", CubeListBuilder.create().texOffs(21, 38).addBox(-1.0F, -2.0F, 0.0F, 1.0F, 2.0F, 1.0F), PartPose.offsetAndRotation(-1.4F, -0.2F, 0.0F, 0.0F, 0.5462880425584197F, -0.32637658343874504F));
            partDefinition.addOrReplaceChild("Mane_1", CubeListBuilder.create().texOffs(8, 39).addBox(-1.0F, -1.4F, 0.0F, 2.0F, 2.0F, 2.0F), PartPose.offsetAndRotation(0.0F, -1.0F, -1.7F, -0.5473352640780661F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -2.7F, -2.5F, 6.0F, 6.0F, 8.0F), PartPose.offsetAndRotation(0.0F, 13.4F, -4.6F, 0.18587755867949335F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(20, 0).addBox(-1.5F, -3.0F, -1.5F, 3.0F, 3.0F, 3.0F), PartPose.offsetAndRotation(0.0F, -0.2F, -1.5F, 0.97947875757709F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("FootRight", CubeListBuilder.create().texOffs(12, 51).mirror(true).addBox(-1.0F, -0.5F, -3.0F, 2.0F, 1.0F, 5.0F), PartPose.offsetAndRotation(0.9F, 6.8F, 0.8F, -0.34487706418882114F, 0.017453292519943295F, 0.0F));
            partDefinition.addOrReplaceChild("Tail6", CubeListBuilder.create().texOffs(16, 58).addBox(-1.0F, -4.0F, -2.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.1F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, -3.9F, 0.0F, 0.5235987755982988F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Tail3", CubeListBuilder.create().texOffs(16, 58).addBox(-1.0F, -4.0F, -2.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.15999997F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, 0.0F, 0.5235987755982988F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Mane_2", CubeListBuilder.create().texOffs(12, 27).addBox(-1.0F, -0.2F, -3.0F, 2.0F, 1.0F, 3.0F), PartPose.offsetAndRotation(0.0F, -1.0F, -1.2F, -0.1563815016444822F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("EarLeft", CubeListBuilder.create().texOffs(21, 38).addBox(0.0F, -2.0F, 0.0F, 1.0F, 2.0F, 1.0F), PartPose.offsetAndRotation(1.4F, -0.2F, 0.0F, 0.0F, -0.5462880425584197F, 0.32637658343874504F));
            partDefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 48).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F), PartPose.offsetAndRotation(0.0F, -3.6F, -0.4F, -1.0552260497768051F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("CheekRight4", CubeListBuilder.create().texOffs(24, 16).mirror(true).addBox(-1.8F, 0.0F, -0.5F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.2F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.7428121536172364F, 0.0F));
            partDefinition.addOrReplaceChild("Mane_3", CubeListBuilder.create().texOffs(8, 39).addBox(-1.0F, -1.4F, 0.0F, 2.0F, 2.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.5473352640780661F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("LegRight", CubeListBuilder.create().texOffs(22, 38).mirror(true).addBox(0.0F, 0.0F, 0.0F, 2.0F, 7.0F, 3.0F), PartPose.offsetAndRotation(-1.0F, 6.5F, -2.0F, 0.4557054783483638F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("CheekLeft2", CubeListBuilder.create().texOffs(0, 27).addBox(0.0F, 0.0F, -0.5F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.2F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, -1.0F, -0.7F, 0.0F, -0.5864306020384839F, 0.3127630032889644F));
            partDefinition.addOrReplaceChild("Tail7", CubeListBuilder.create().texOffs(16, 58).addBox(-1.0F, -4.0F, -2.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.08F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, 0.0F, 0.5235987755982988F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("HandLeft", CubeListBuilder.create().texOffs(15, 46).addBox(-1.0F, -1.0F, -2.5F, 2.0F, 1.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 5.8F, -0.5F, 1907508222411F, 0.0F, -0.11728612207217244F));
            partDefinition.addOrReplaceChild("Mane", CubeListBuilder.create().texOffs(7, 34).addBox(-1.5F, -1.0F, -4.0F, 3.0F, 1.0F, 4.0F), PartPose.offsetAndRotation(0.0F, -1.9F, 1.8F, 0.1563815016444822F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("CheekLeft4", CubeListBuilder.create().texOffs(24, 16).addBox(-0.2F, 0.0F, -0.5F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.2F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.7428121536172364F, 0.0F));
            partDefinition.addOrReplaceChild("ArmBaseLeft", CubeListBuilder.create().texOffs(24, 48).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 5.0F, 2.0F), PartPose.offset(2.2F, 0.4F, -1.6F));
            partDefinition.addOrReplaceChild("Snout", CubeListBuilder.create().texOffs(0, 44).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 2.0F, 2.0F), PartPose.offsetAndRotation(0.0F, -0.1F, -1.3F, 0.2405063662642867F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Tail1", CubeListBuilder.create().texOffs(16, 58).addBox(-1.0F, -4.0F, -2.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.2F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 2.0F, 7.0F, -0.9808750529366187F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(16, 58).addBox(-1.0F, -4.0F, -2.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.18000007F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, 0.0F, 0.2890265148091971F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("CheekRight3", CubeListBuilder.create().texOffs(8, 43).mirror(true).addBox(-3.0F, 0.0F, -0.5F, 3.0F, 4.0F, 1.0F, new CubeDeformation(0.2F, 0.0F, 0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Tail5", CubeListBuilder.create().texOffs(16, 58).addBox(-1.0F, -4.0F, -2.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.12F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, 0.0F, 0.5235987755982988F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("CheekRight2", CubeListBuilder.create().texOffs(0, 27).mirror(true).addBox(-2.0F, 0.0F, -0.5F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.2F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, -1.0F, -0.7F, 0.0F, 0.5864306020384839F, -0.3127630032889644F));
            partDefinition.addOrReplaceChild("ThighRight", CubeListBuilder.create().texOffs(18, 27).mirror(true).addBox(-1.5F, -0.5F, -2.5F, 3.0F, 7.0F, 4.0F), PartPose.offsetAndRotation(-2.2F, 1.3F, 6.4F, -0.1563815016444822F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("FootLeft", CubeListBuilder.create().texOffs(12, 51).addBox(-1.0F, -0.5F, -3.0F, 2.0F, 1.0F, 5.0F), PartPose.offsetAndRotation(1.1F, 6.8F, 0.8F, -0.34487706418882114F, -0.017453292519943295F, 0.0F));
            partDefinition.addOrReplaceChild("ArmBaseRight", CubeListBuilder.create().texOffs(24, 48).mirror(true).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 5.0F, 2.0F), PartPose.offset(-2.2F, 0.4F, -1.6F));
            partDefinition.addOrReplaceChild("Tail9", CubeListBuilder.create().texOffs(0, 1).addBox(-1.0F, -4.0F, -2.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.04F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, 0.0F, 0.5235987755982988F, 0.0F, 0.0F));
