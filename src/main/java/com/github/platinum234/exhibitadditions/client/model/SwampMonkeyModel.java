...
public abstract class SwampMonkeyModel extends ZawaBaseModel<SwampMonkeyEntity> {
    ...
    public static class Adult extends SwampMonkeyModel {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            PartDefinition Chest = partDefinition.addOrReplaceChild("Chest", CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, -2.5F, -2.0F, 5.0F, 5.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 15.8F, -2.5F, -0.05951572899103476F, 0.0F, 0.0F));
            PartDefinition Neck = Chest.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(0, 31).addBox(-1.5F, -2.5F, -2.0F, 3.0F, 4.0F, 3.0F, new CubeDeformation(-0.1F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, -0.3F, -1.3F, -0.2792526803190927F, 0.0F, 0.0F));
            PartDefinition Head = Neck.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(27, 9).addBox(-1.5F, -1.5F, -2.0F, 3.0F, 3.0F, 3.0F), PartPose.offsetAndRotation(0.0F, -0.6F, -2.3F, 0.3717551173589867F, 0.0F, 0.0F));
            PartDefinition EyebrowRight = Head.addOrReplaceChild("EyebrowRight", CubeListBuilder.create().texOffs(23, 18).mirror(true).addBox(-2.0F, 0.0F, 0.0F, 2.0F, 1.0F, 4.0F), PartPose.offsetAndRotation(0.0F, -1.9F, -2.2F, 0.10594148859211201F, 0.0F, -0.11693705655466871F));

            PartDefinition EarRight = Head.addOrReplaceChild("EarRight", CubeListBuilder.create().texOffs(33, 1).mirror(true).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F), PartPose.offsetAndRotation(-1.7F, -1.9F, 0.2F, 0.0F, -0.5715953300281429F, 0.0F));

            PartDefinition Mouth = Head.addOrReplaceChild("Mouth", CubeListBuilder.create().texOffs(19, 10).addBox(-1.0F, -0.5F, -0.8F, 2.0F, 1.0F, 2.0F, new CubeDeformation(-0.1F, 0.0F, 0.0F)), PartPose.offset(0.0F, 2.0F, -1.5F));

            PartDefinition EyebrowLeft = Head.addOrReplaceChild("EyebrowLeft", CubeListBuilder.create().texOffs(23, 18).addBox(0.0F, 0.0F, 0.0F, 2.0F, 1.0F, 4.0F), PartPose.offsetAndRotation(0.0F, -1.9F, -2.2F, 0.10594148859211201F, 0.0F, 0.11693705655466871F));

            PartDefinition SideburnRight = Head.addOrReplaceChild("SideburnRight", CubeListBuilder.create().texOffs(25, 1).mirror(true).addBox(-1.0F, 0.0F, 0.0F, 1.0F, 4.0F, 3.0F), PartPose.offsetAndRotation(-1.6F, -1.5F, -1.6F, -0.14451325740459856F, 0.0F, -0.22689280275926282F));

            PartDefinition EarLeft = Head.addOrReplaceChild("EarLeft", CubeListBuilder.create().texOffs(33, 1).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F), PartPose.offsetAndRotation(1.7F, -1.8F, 0.2F, 0.0F, 0.5715953300281429F, 0.0F));

            PartDefinition SideburnLeft = Head.addOrReplaceChild("SideburnLeft", CubeListBuilder.create().texOffs(25, 1).addBox(0.0F, 0.0F, 0.0F, 1.0F, 4.0F, 3.0F), PartPose.offsetAndRotation(1.6F, -1.5F, -1.6F, -0.14451325740459856F, 0.0F, 0.22689280275926282F));

            PartDefinition TopMouth = Head.addOrReplaceChild("TopMouth", CubeListBuilder.create().texOffs(16, 6).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 1.0F, -2.6F, 0.25289820461923673F, 0.0F, 0.0F));
            PartDefinition Nose = TopMouth.addOrReplaceChild("Nose", CubeListBuilder.create().texOffs(19, 0).addBox(-0.5F, -2.0F, 0.0F, 1.0F, 2.0F, 1.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 0.1F, -0.6923720823082175F, 0.0F, 0.0F));

            PartDefinition ArmLeft = Chest.addOrReplaceChild("ArmLeft", CubeListBuilder.create().texOffs(17, 24).addBox(-2.0F, 0.0F, -1.5F, 3.0F, 5.0F, 3.0F), PartPose.offsetAndRotation(2.1F, -0.6F, 0.0F, 0.13962634015954636F, 0.0F, 0.0F));
            PartDefinition ForearmLeft = ArmLeft.addOrReplaceChild("ForearmLeft", CubeListBuilder.create().texOffs(15, 33).addBox(-1.0F, 0.0F, -1.5F, 2.0F, 5.0F, 2.0F), PartPose.offsetAndRotation(-0.2F, 3.4F, 0.6F, -0.13962634015954636F, 0.0F, 0.13962634015954636F));
            PartDefinition HandLeft = ForearmLeft.addOrReplaceChild("HandLeft", CubeListBuilder.create().texOffs(24, 33).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 1.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 4.6F, -1.0F, 0.05235987755982988F, 0.0F, -0.13962634015954636F));
            PartDefinition ThumbLeft = HandLeft.addOrReplaceChild("ThumbLeft", CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, 0.0F, -1.0F, 1.0F, 1.0F, 1.0F), PartPose.offsetAndRotation(-0.5F, 0.05F, 0.1F, 0.0F, 0.33161255787892263F, 0.0F));

            PartDefinition Body = Chest.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 10).addBox(-3.0F, 0.0F, -0.2F, 6.0F, 5.0F, 6.0F), PartPose.offsetAndRotation(0.0F, -2.5F, 0.5F, 0.09145524880976123F, 0.0F, 0.0F));
            PartDefinition Hips = Body.addOrReplaceChild("Hips", CubeListBuilder.create().texOffs(0, 22).addBox(-2.5F, 0.0F, 0.0F, 5.0F, 5.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 5.5F, -0.1424188642995762F, 0.0F, 0.0F));
            PartDefinition ThighLeft = Hips.addOrReplaceChild("ThighLeft", CubeListBuilder.create().texOffs(30, 24).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 5.0F, 3.0F), PartPose.offset(2.2F, 1.8F, 1.1F));
            PartDefinition LegLeft = ThighLeft.addOrReplaceChild("LegLeft", CubeListBuilder.create().texOffs(35, 33).addBox(-1.0F, 0.0F, -0.5F, 2.0F, 4.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 4.6F, -0.5F, 0.08726646259971647F, 0.0F, 0.0F));
            PartDefinition FootLeft = LegLeft.addOrReplaceChild("FootLeft", CubeListBuilder.create().texOffs(24, 38).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 1.0F, 3.0F), PartPose.offset(-0.1F, 3.5F, -0.1F));

            PartDefinition ThighRight = Hips.addOrReplaceChild("ThighRight", CubeListBuilder.create().texOffs(30, 24).mirror(true).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 5.0F, 3.0F), PartPose.offset(-2.2F, 1.8F, 1.1F));
            PartDefinition LegRight = ThighRight.addOrReplaceChild("LegRight", CubeListBuilder.create().texOffs(35, 33).mirror(true).addBox(-1.0F, 0.0F, -0.5F, 2.0F, 4.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 4.6F, -0.5F, 0.08726646259971647F, 0.0F, 0.0F));
            PartDefinition FootRight = LegRight.addOrReplaceChild("FootRight", CubeListBuilder.create().texOffs(24, 38).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 1.0F, 3.0F), PartPose.offset(0.1F, 3.5F, -0.1F));

            PartDefinition Tail1 = Hips.addOrReplaceChild("Tail1", CubeListBuilder.create().texOffs(0, 38).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 2.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 3.0F, -0.9627236127369111F, 0.0F, 0.0F));
            PartDefinition Tail2 = Tail1.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(0, 38).addBox(-1.0F, -2.0F, 0.0F, 2.0F, 2.0F, 3.0F), PartPose.offsetAndRotation(0.01F, 2.0F, 3.0F, 0.28763025273918225F, 0.0F, 0.0F));
            PartDefinition Tail3 = Tail2.addOrReplaceChild("Tail3", CubeListBuilder.create().texOffs(0, 38).addBox(-1.0F, -2.0F, 0.0F, 2.0F, 2.0F, 3.0F), PartPose.offsetAndRotation(-0.01F, 0.0F, 3.0F, 0.28763025273918225F, 0.0F, 0.0F));
            PartDefinition Tail4 = Tail3.addOrReplaceChild("Tail4", CubeListBuilder.create().texOffs(0, 38).addBox(-1.0F, -2.0F, 0.0F, 2.0F, 2.0F, 3.0F), PartPose.offsetAndRotation(0.01F, 0.0F, 3.0F, 0.2485348814892509F, 0.0F, 0.0F));
            PartDefinition Tail5 = Tail4.addOrReplaceChild("Tail5", CubeListBuilder.create().texOffs(0, 38).addBox(-1.0F, -2.0F, 0.0F, 2.0F, 2.0F, 3.0F), PartPose.offsetAndRotation(-0.01F, 0.0F, 3.0F, 0.20943951023931953F, 0.0F, 0.0F));
            PartDefinition Tail6 = Tail5.addOrReplaceChild("Tail6", CubeListBuilder.create().texOffs(0, 38).addBox(-1.0F, -2.0F, 0.0F, 2.0F, 2.0F, 3.0F), PartPose.offsetAndRotation(0.01F, 0.0F, 3.0F, 0.20943951023931953F, 0.0F, 0.0F));

            PartDefinition ArmRight = Chest.addOrReplaceChild("ArmRight", CubeListBuilder.create().texOffs(17, 24).mirror(true).addBox(-1.0F, 0.0F, -1.5F, 3.0F, 5.0F, 3.0F), PartPose.offsetAndRotation(-2.1F, -0.6F, 0.0F, 0.13962634015954636F, 0.0F, 0.0F));
            PartDefinition ForearmRight = ArmRight.addOrReplaceChild("ForearmRight", CubeListBuilder.create().texOffs(15, 33).mirror(true).addBox(-1.0F, 0.0F, -1.5F, 2.0F, 5.0F, 2.0F), PartPose.offsetAndRotation(0.2F, 3.4F, 0.6F, -0.13962634015954636F, 0.0F, -0.13962634015954636F));
            PartDefinition HandRight = ForearmRight.addOrReplaceChild("HandRight", CubeListBuilder.create().texOffs(24, 33).mirror(true).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 1.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 4.6F, -1.0F, 0.05235987755982988F, 0.0F, 0.13962634015954636F));
            PartDefinition ThumbRight = HandRight.addOrReplaceChild("ThumbRight", CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, 0.0F, -1.0F, 1.0F, 1.0F, 1.0F), PartPose.offsetAndRotation(0.5F, 0.05F, 0.1F, 0.0F, -0.33161255787892263F, 0.0F));
    ...
    public static class Child extends SwampMonkeyModel {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            PartDefinition Chest = partDefinition.addOrReplaceChild("Chest", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F), PartPose.offsetAndRotation(0.0F, 18.1F, 0.0F, -0.08726646259971647F, 0.0F, 0.0F));
            PartDefinition Tail1 = Chest.addOrReplaceChild("Tail1", CubeListBuilder.create().texOffs(0, 22).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 2.0F, 3.0F), PartPose.offsetAndRotation(0.0F, -1.8F, 2.0F, -0.7155849933176751F, 0.0F, 0.0F));
            ...
            PartDefinition Body = Chest.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(16, 0).addBox(-1.5F, 0.0F, -4.0F, 3.0F, 4.0F, 4.0F), PartPose.offsetAndRotation(0.0F, -2.0F, -2.0F, 0.22689280275926282F, 0.0F, 0.0F));
            PartDefinition Neck = Body.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(23, 8).addBox(-1.5F, -1.5F, -2.0F, 3.0F, 3.0F, 4.0F, new CubeDeformation(-0.1F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.9F, -3.8F, -0.7239625657377646F, 0.0F, 0.0F));
            ...
            PartDefinition ArmLeft = Body.addOrReplaceChild("ArmLeft", CubeListBuilder.create().texOffs(14, 8).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 3.0F, 2.0F), PartPose.offsetAndRotation(1.1F, 1.9F, -2.6F, 0.06981317007977318F, 0.0F, -0.13962634015954636F));
            ...
            PartDefinition ArmRight = Body.addOrReplaceChild("ArmRight", CubeListBuilder.create().texOffs(14, 8).mirror(true).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 3.0F, 2.0F), PartPose.offsetAndRotation(-1.1F, 1.9F, -2.6F, 0.06981317007977318F, 0.0F, 0.13962634015954636F));
            ...
            PartDefinition ThighRight = Chest.addOrReplaceChild("ThighRight", CubeListBuilder.create().texOffs(0, 8).mirror(true).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F), PartPose.offsetAndRotation(-1.3F, -0.9F, 1.3F, -0.20943951023931953F, 0.0F, 0.0F));
            ...
            PartDefinition ThighLeft = Chest.addOrReplaceChild("ThighLeft", CubeListBuilder.create().texOffs(0, 8).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F), PartPose.offsetAndRotation(1.3F, -0.9F, 1.3F, -0.20943951023931953F, 0.0F, 0.0F));
